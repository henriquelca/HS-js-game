...
// these function controls the shipp's movement// these function controls the shipp's movement
function moveS(e){
...
/*
    if (e.keyCode == Keyboard.LEFT) {
        //ship.setPosition( (getWidth() * 0.315 + getWidth() * 0.125 * 1) - (getWidth() * 0.1)/2 , (getHeight() - getHeight() * 0.2) - getHeight() * 0.01);
        if (ship.getWidth() + (getWidth() * 0.1)/2 == (getWidth() * 0.315 + getWidth() * 0.125 * 3) - (getWidth() * 0.1)/2 , (getHeight() - getHeight() * 0.2) - getHeight() * 0.01){
            ship.setPosition((getWidth() * 0.315 + getWidth() * 0.125 * 2) - (getWidth() * 0.1)/2 , (getHeight() - getHeight() * 0.2) - getHeight() * 0.01);
        }else{
            if (ship.getWidth() - (getWidth() * 0.1)/2 == (getWidth() * 0.315 + getWidth() * 0.125 * 2) - (getWidth() * 0.1)/2 , (getHeight() - getHeight() * 0.2) - getHeight() * 0.01){
                ship.setPosition((getWidth() * 0.315 + getWidth() * 0.125 * 1) - (getWidth() * 0.1)/2 , (getHeight() - getHeight() * 0.2) - getHeight() * 0.01);
            }else{
                if (ship.getWidth() - (getWidth() * 0.1)/2 ==(getWidth() * 0.315 + getWidth() * 0.125 * 1) - (getWidth() * 0.1)/2 , (getHeight() - getHeight() * 0.2) - getHeight() * 0.01){
                    ship.setPosition((getWidth() * 0.315 + getWidth() * 0.125 * 1) - (getWidth() * 0.1)/2 , (getHeight() - getHeight() * 0.2) - getHeight() * 0.01);
                }else{
                    ship.setPosition((getWidth() * 0.315 + getWidth() * 0.125 * 1) - (getWidth() * 0.1)/2 , (getHeight() - getHeight() * 0.2) - getHeight() * 0.01);
                }
    ...
    if (e.kyeCode == Keyboard.RIGHT){
        if (ship.getWidth()/2 == getWidth() * 0.315 + getWidth() * 0.125 * 0 , 0){
            ship.setPosition(ship.getWidth()/2 == getWidth() * 0.315 + getWidth() * 0.125 * 1 , 0);
        }else{
            if (ship.getWidth()/2 == getWidth() * 0.315 + getWidth() * 0.125 * 1 , 0){
            ship.setPosition(ship.getWidth()/2 == getWidth() * 0.315 + getWidth() * 0.125 * 2 , 0);
            }else{
                if (ship.getWidth()/2 == getWidth() * 0.315 + getWidth() * 0.125 * 2 , 0){
                ship.setPosition(ship.getWidth()/2 == getWidth() * 0.315 + getWidth() * 0.125 * 3 , 0);
                }else{
                    ship.setPosition(ship.getWidth()/2 == getWidth() * 0.315 + getWidth() * 0.125 * 2 , 0);
                }
            }
